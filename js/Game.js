...
GodDangZombies.Game = function (game) {
    ...
    this.blockedLayer;
  //  this.map      //  the repeatable random number generator (Phaser.RandomDataGenerator)

    //  You can use any of these from any function within this State.
    //  But do consider them as being 'reserved words', i.e. don't create a property for your own game called 'world' or you'll over-write the world reference.
};

GodDangZombies.Game.prototype = {
    ...
    create: function () {
      ...
      //  this.background.scale.setTo(2);
        ...
        this.map.addTilesetImage('TILESET-04', 'tiles1');
        this.map.addTilesetImage('spritesheet', 'tiles2');

        this.backgroundLayer = this.map.createLayer('backgroundLayer');
        //this.backgroundLayer.scale.setTo(2.0);


        this.blockedLayer = this.map.createLayer('blockedLayer');

        //this.blockedLayer.scale.setTo(2.0);
...
*/
    ...
    playerHandler: function() {
        ...
        if (this.player.alive) {
            ...
            if (this.game.input.activePointer.isDown) {
                this.playerAttacks.rate = 20 - (this.player.speed * 3);
                    if (this.playerAttacks.rate < 100) {
                        this.playerAttacks.rate = 100;
                    }
                this.playerAttacks.range = this.player.strength * 100;
    ...
    generatePlayer: function () {
        ...
        player.name = 'GodDangZombies';
        player.level = 1;

        player.health = 10000000;
        player.vitality = 10000000;
        player.strength = 25;
        player.speed = 125;
    ...
    generateEnemy: function () {
        ...
        enemy = this.enemies.create(this.game.world.randomX, this.game.world.randomY, 'zombies');
