...
Theodoric.Preloader.prototype = {
	...
	preload: function () {
		...
		this.load.image('sword', 'assets/images/sword.png', 50, 3);
		...
		this.load.tilemap('tilemap1', 'assets/tilemaps/tilemap1.json', null, Phaser.Tilemap.TILED_JSON);
		this.load.image('tiles1', 'assets/images/TILESET-04.png', 32, 32);
		this.load.image('tiles2', 'assets/images/spritesheet.png',32 ,32);
		...
		this.load.spritesheet('zombies', 'assets/images/zombies_.png', 16, 16);
